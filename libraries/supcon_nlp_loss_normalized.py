# This is the realization of Supervised Contrastive Loss for NLP encoder training
# Especially, the sentence embeddings are normalized before calculation, so the dot product can be regraded as the similarity directly
...
class SupervisedContrastiveNLPLoss(nn.Module):
    ...
    def forward(self, sentence_features: Iterable[Dict[str, Tensor]], labels: Tensor):
        ...
        embeddings_b = torch.nn.functional.normalize(torch.cat(reps[1:]), p=2, dim=1)
